...
#ifndef BWE_SRC_ALGORITHMS_TSBPD_RESERVE_ESTIMATOR_HPP_
#define BWE_SRC_ALGORITHMS_TSBPD_RESERVE_ESTIMATOR_HPP_
...
#endif  // BWE_SRC_ALGORITHMS_TSBPD_RESERVE_ESTIMATOR_HPP_

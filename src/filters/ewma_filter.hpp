...
#ifndef BWE_SRC_FILTERS_EWMA_FILTER_HPP_
#define BWE_SRC_FILTERS_EWMA_FILTER_HPP_
...
class EwmaFilter {
 public:
  ...
  bool HasValue() const noexcept { return samples_ > 0; }
...
#endif  // BWE_SRC_FILTERS_EWMA_FILTER_HPP_
